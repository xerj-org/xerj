...
// The scheduler moved to `crate::microbatch` so the Candle backend can bound
// its forwards the same way (#366); the ONNX call sites and their limits are
// unchanged.
pub use crate::microbatch::{plan_microbatches, MicrobatchConfig, MAX_TOKENS};

# Comparison table — 46 projects' llms.txt, measured 2026-09-18

Generated mechanically from `data/dissections.json`. Sorted by llms.txt size. "Install" = whether installation commands appear in llms.txt itself.

**Distribution of llms.txt size (bytes):** min 1,674 · p25 16,049 · median 25,717 · p75 44,802 · max 175,811. **XERJ: 40,064 bytes, 234 lines — rank 35 of 47.**

**Counts:** install commands absent from llms.txt in 27/46 · agent-addressed text in 22 · one-click links in 20 · MCP snippet in 21 · a feedback/contribution ask in 23 · llms-full.txt published by 37.

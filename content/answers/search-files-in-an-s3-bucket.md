...
faq:
  ...
  - q: "What happens to search results when someone deletes an object?"
    a: "The next run removes it from the local mirror, and the existing incremental reconcile deletes its documents. There is no second deletion mechanism to configure."
